  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed top-20 left-4 z-50 p-2 bg-indigo-600 text-white rounded-lg shadow-lg hover:bg-indigo-700 transition hover:cursor-pointer"
      >
      ...
      >
        <div className="flex flex-col h-full px-6 py-6 space-y-6">
          ...
          <motion.a
            ...
            className="flex items-center justify-center gap-2 border-slate-200 bg-gradient-to-r from-indigo-400 to-slate-400 font-medium px-4 py-2 rounded-md border border-indigo-200 shadow-sm hover:bg-indigo-200 transition text-white"
          >
